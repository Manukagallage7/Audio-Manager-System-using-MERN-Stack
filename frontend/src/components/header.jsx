...
export default function Header() {
    return (
        <header className='w-full h-[100px] relative bg-blue-800 flex justify-center items-center gap-10'>
            ...
            <Link to="/homePage/" className='text-white text-3xl font-bold m-1'>Home</Link>
            ...
            <Link to="/homePage/booking" className='text-white text-3xl font-bold m-1'><FaCartShopping/></Link>
        </header>
